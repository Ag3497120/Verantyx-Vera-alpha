# -*- coding: utf-8 -*-
"""確認測定7 — PREREG7.md が事前登録。mathlib断片の手渡し(票なし・昇格なし)。"""
...
LEDGER = Path(__file__).with_name("proof_ledger10.json")
...
def main():
    ...
    Path(__file__).with_name("results_confirm10.json").write_text(
